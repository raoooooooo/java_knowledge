...
| 文件 | 核心内容 |
|------|---------|
| [01-排序算法.md](./07-算法与数据结构/01-排序算法.md)  | 十大排序全总结：冒泡/选择/插入/希尔/快排/归并/堆排/计数/桶/基数，含复杂度对比、手撕代码、优化技巧、选型指南 |
| [02-二叉树.md](./07-算法与数据结构/02-二叉树.md)  | 二叉树全考点：基础概念、7种特殊二叉树（满/完全/BST/AVL/红黑树/堆/哈夫曼）、4种遍历（递归+迭代）、11道经典题型与解题模板 |
| [03-分治算法.md](./07-算法与数据结构/03-分治算法.md)  | 分治思想三步法、7个经典算法（归并/快排/二分/汉诺塔/最大子数组/逆序对/快速幂）、解题模板、主定理、LeetCode 题单 |
...
| [15-Flink常见异常场景与解决方案.md](./12-大数据/Flink/15-Flink常见异常场景与解决方案.md) | 11大生产异常场景深度剖析(反压/数据倾斜/频繁重启/CP失败/OOM/TM丢失/水位线不推进/状态膨胀/exactly-once失效/Kafka Lag/迟到数据)、12道场景题面试答题框架、资料勘误10条 |
